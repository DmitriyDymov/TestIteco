<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.cs" Inherits="TestIteco.PrivacyPolicy" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            ooo DEKRA RUSS built the Performer app as a Free app. This SERVICE is provided by ooo DEKRA RUSS at no cost and is intended for use as is.<br />
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Performer unless otherwise defined in this Privacy Policy.<br />

Information Collection and Use<br />

For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to The exact coordinates of the device. The information that we request will be retained by us and used as described in this privacy policy.<br />
...
We want to inform users of this Service that these third parties have access to their Personal Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or use the information for any other purpose.<br />
...
This policy is effective as of 2021-12-10<br />

Contact Us<br />

If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at it@dekrarus.ru.
        </div>
    </form>
</body>
</html>
