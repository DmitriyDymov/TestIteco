...
function signInButtonOnClick(s, e) {
    if (ASPxClientEdit.AreEditorsValid()) {
        var email = userNameTextBox.GetValue();
        var password = passwordButtonEdit.GetValue();
        logonCallback.PerformCallback(email + "|" + password);
    }
}
